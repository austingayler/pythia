# source: http://www.raspberrypi.org/forums/viewtopic.php?f=63&t=29061 (post by spaceharrier)
# https://github.com/spaceharrier/dogcam/blob/master/noise_monitor.py
#!/usr/bin/python
